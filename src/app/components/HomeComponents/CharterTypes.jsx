                ...
                <div className="flex flex-col md:flex-row md:grid md:grid-cols-3 md:flex-wrap md:gap-6 items-center self-stretch">
                    <div className="flex items-center md:flex-col self-stretch mb-6 gap-4">
                        ...
                        <div className="flex flex-col items-start w-3/5 md:w-full gap-2">
                            ...
                            <Link href="/charters/inshore-backcountry" className="text-cyan-420 hover:text-cyan-hover transition duration-100 ease-in-out text-md medium">Explore Inshore</Link>
                        </div>
                    </div>
                    <div className="flex items-center md:flex-col self-stretch mb-6 gap-4">
                        <div className="w-2/5 md:w-auto">
                        ...
                        <div className="flex flex-col items-start w-3/5 md:w-full gap-2">
                            ...
                            <Link href="/charters/offshore" className="text-cyan-420 hover:text-cyan-hover transition duration-100 ease-in-out text-md medium">Explore Offshore</Link>
                        </div>
                    </div>
                    <div className="flex items-center md:flex-col self-stretch md:mb-6 gap-4">
                        ...
                        <div className="flex flex-col items-start w-3/5 md:w-full gap-2">
                            ...
                            <Link href="/charters/eco-enviro-tours" className="text-cyan-420 hover:text-cyan-hover transition duration-100 ease-in-out text-md medium">Explore Eco Tours</Link>
                        </div>
                    </div>
                </div>
        </section>
