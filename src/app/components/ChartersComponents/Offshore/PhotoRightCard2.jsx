    ...
    return (
        <div className="fade-in flex flex-col md:flex-row items-center gap-6 lg:gap-28 order-1 mb-16">
            ...
            <div className="flex flex-col md:order-0 lg:ml-20">
                <h4 className={`text-2xl md:text-3xl leading-7 mb-4 ${apercuMedium.className}`}>Dolphin Pursuit</h4>
                ...
                <p className={`text-sm md:text-base mb-4 ${apercuBold.className}`}>Availability: May - August</p>
